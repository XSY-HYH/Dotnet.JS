...
// TS 行内语法高亮，ANSI 真彩色，配色参考 VSCode Dark+
// 基于 JS 高亮，加 TS 类型关键字与类型注解着色
internal static class TsHighlighter
{
    internal static readonly HashSet<string> Keywords = new()
    {
        ...
        // TS 类型关键字
        "number", "string", "boolean", "any", "unknown", "never", "symbol",
        "bigint", "object", "asserts", "satisfies", "override", "unique"
    };
